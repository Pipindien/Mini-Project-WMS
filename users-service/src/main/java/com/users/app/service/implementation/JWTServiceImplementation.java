...
public class JWTServiceImplementation implements JWTService {
    ...
    private Key getSigningKey() {
        return Keys.hmacShaKeyFor(Base64.getDecoder().decode(secretKey)); // decode base64
    }

    public String generateToken(String username, Long custId) {
    ...
    public Long extractCustId(String token) {
